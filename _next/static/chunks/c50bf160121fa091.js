...
`,tE=tb(tS,25),tk="transparent",tj=`'Urbanist', -apple-system, 'BlinkMacSystemFont',
...
`,tW=({size:e,onClick:t})=>(0,r.jsx)(tB,{type:"button",$size:e,onClick:t,children:(0,r.jsx)(tM,{})}),tY="cubic-bezier(0.16, 1, 0.3, 1)",tU=ty`
  from {
    opacity: 0;
...
`,tH=th`
  animation: ${tU} ${tY} 0.4s 1 forwards;
  opacity: 0;
...
`,tX="0.1s",tK=tm.form.withConfig({displayName:"Form",componentId:"sc-6bd0e623-0"})`
  background-color: ${tw};
...
`,tJ=tm.button.withConfig({displayName:"SubmitButton__StyledSubmitButton",componentId:"sc-5c592282-0"})`
  align-self: flex-end;
  background: ${tS};
  border: none;
  color: ${tw};
...
`,tZ=tm.span.withConfig({displayName:"SubmitButton__ButtonLabel",componentId:"sc-5c592282-1"})`
  position: relative;
`,tQ=({children:e,...t})=>(0,r.jsx)(tJ,{type:"submit",...t,children:(0,r.jsx)(tZ,{children:e})}),t0=th`
...
`,t1=tm.label.withConfig({displayName:"Label__StyledLabel",componentId:"sc-81e03508-0"})`
  display: inline-block;
  font-size: ${t_};
  margin-bottom: 0.5rem;
`,t2=({htmlFor:e,label:t})=>(0,r.jsx)(t1,{htmlFor:e,children:t}),t5=tm.textarea.withConfig({displayName:"TextArea__StyledTextArea",componentId:"sc-e0320a96-0"})`
  ${t0};
  min-height: 6rem;
`,t3=({id:e,label:t,...n})=>(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(t2,{htmlFor:e,label:t}),(0,r.jsx)(t5,{name:e,id:e,...n})]}),t4=tm.input.withConfig({displayName:"TextField__StyledTextField",componentId:"sc-84e205c1-0"})`
  ${t0};
`,t6=({id:e,label:t,...n})=>(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(t2,{htmlFor:e,label:t}),(0,r.jsx)(t4,{type:"text",name:e,id:e,...n})]});function t9(){return(t9=Object.assign.bind()).apply(null,arguments)}function t8(e,t){if(null==e)return{};var n={};for(var r in e)if(({}).hasOwnProperty.call(e,r)){if(-1!==t.indexOf(r))continue;n[r]=e[r]}return n}function t7(e,t){return(t7=Object.setPrototypeOf?Object.setPrototypeOf.bind():function(e,t){return e.__proto__=t,e})(e,t)}function ne(e,t){e.prototype=Object.create(t.prototype),e.prototype.constructor=e,t7(e,t)}function nt(e,t){return e.replace(RegExp("(^|\\s)"+t+"(?:\\s|$)","g"),"$1").replace(/\s+/g," ").replace(/^\s*|\s*$/g,"")}var nn=e.i(943);let nr=i.default.createContext(null);var ni=function(e){return e.scrollTop},no="unmounted",na="exited",ns="entering",nl="entered",nc="exiting",nu=function(e){function t(t,n){var r,i=e.call(this,t,n)||this,o=n&&!n.isMounting?t.enter:t.appear;return i.appearStatus=null,t.in?o?(r=na,i.appearStatus=ns):r=nl:r=t.unmountOnExit||t.mountOnEnter?no:na,i.state={status:r},i.nextCallback=null,i}ne(t,e),t.getDerivedStateFromProps=function(e,t){return e.in&&t.status===no?{status:na}:null};var n=t.prototype;return n.componentDidMount=function(){this.updateStatus(!0,this.appearStatus)},n.componentDidUpdate=function(e){var t=null;if(e!==this.props){var n=this.state.status;this.props.in?n!==ns&&n!==nl&&(t=ns):(n===ns||n===nl)&&(t=nc)}this.updateStatus(!1,t)},n.componentWillUnmount=function(){this.cancelNextCallback()},n.getTimeouts=function(){var e,t,n,r=this.props.timeout;return e=t=n=r,null!=r&&"number"!=typeof r&&(e=r.exit,t=r.enter,n=void 0!==r.appear?r.appear:t),{exit:e,enter:t,appear:n}},n.updateStatus=function(e,t){if(void 0===e&&(e=!1),null!==t)if(this.cancelNextCallback(),t===ns){if(this.props.unmountOnExit||this.props.mountOnEnter){var n=this.props.nodeRef?this.props.nodeRef.current:nn.default.findDOMNode(this);n&&ni(n)}this.performEnter(e)}else this.performExit();else this.props.unmountOnExit&&this.state.status===na&&this.setState({status:no})},n.performEnter=function(e){var t=this,n=this.props.enter,r=this.context?this.context.isMounting:e,i=this.props.nodeRef?[r]:[nn.default.findDOMNode(this),r],o=i[0],a=i[1],s=this.getTimeouts(),l=r?s.appear:s.enter;(e||n)&&1?(this.props.onEnter(o,a),this.safeSetState({status:ns},function(){t.props.onEntering(o,a),t.onTransitionEnd(l,function(){t.safeSetState({status:nl},function(){t.props.onEntered(o,a)})})})):this.safeSetState({status:nl},function(){t.props.onEntered(o)})},n.performExit=function(){var e=this,t=this.props.exit,n=this.getTimeouts(),r=this.props.nodeRef?void 0:nn.default.findDOMNode(this);t?(this.props.onExit(r),this.safeSetState({status:nc},function(){e.props.onExiting(r),e.onTransitionEnd(n.exit,function(){e.safeSetState({status:na},function(){e.props.onExited(r)})})})):this.safeSetState({status:na},function(){e.props.onExited(r)})},n.cancelNextCallback=function(){null!==this.nextCallback&&(this.nextCallback.cancel(),this.nextCallback=null)},n.safeSetState=function(e,t){t=this.setNextCallback(t),this.setState(e,t)},n.setNextCallback=function(e){var t=this,n=!0;return this.nextCallback=function(r){n&&(n=!1,t.nextCallback=null,e(r))},this.nextCallback.cancel=function(){n=!1},this.nextCallback},n.onTransitionEnd=function(e,t){this.setNextCallback(t);var n=this.props.nodeRef?this.props.nodeRef.current:nn.default.findDOMNode(this),r=null==e&&!this.props.addEndListener;if(!n||r)return void setTimeout(this.nextCallback,0);if(this.props.addEndListener){var i=this.props.nodeRef?[this.nextCallback]:[n,this.nextCallback],o=i[0],a=i[1];this.props.addEndListener(o,a)}null!=e&&setTimeout(this.nextCallback,e)},n.render=function(){var e=this.state.status;if(e===no)return null;var t=this.props,n=t.children,r=(t.in,t.mountOnEnter,t.unmountOnExit,t.appear,t.enter,t.exit,t.timeout,t.addEndListener,t.onEnter,t.onEntering,t.onEntered,t.onExit,t.onExiting,t.onExited,t.nodeRef,t8(t,["children","in","mountOnEnter","unmountOnExit","appear","enter","exit","timeout","addEndListener","onEnter","onEntering","onEntered","onExit","onExiting","onExited","nodeRef"]));return i.default.createElement(nr.Provider,{value:null},"function"==typeof n?n(e,r):i.default.cloneElement(i.default.Children.only(n),r))},t}(i.default.Component);function nd(){}nu.contextType=nr,nu.propTypes={},nu.defaultProps={in:!1,mountOnEnter:!1,unmountOnExit:!1,appear:!1,enter:!0,exit:!0,onEnter:nd,onEntering:nd,onEntered:nd,onExit:nd,onExiting:nd,onExited:nd},nu.UNMOUNTED=no,nu.EXITED=na,nu.ENTERING=ns,nu.ENTERED=nl,nu.EXITING=nc;var np=function(e,t){return e&&t&&t.split(" ").forEach(function(t){e.classList?e.classList.remove(t):"string"==typeof e.className?e.className=nt(e.className,t):e.setAttribute("class",nt(e.className&&e.className.baseVal||"",t))})},nf=function(e){function t(){for(var t,n=arguments.length,r=Array(n),i=0;i<n;i++)r[i]=arguments[i];return(t=e.call.apply(e,[this].concat(r))||this).appliedClasses={appear:{},enter:{},exit:{}},t.onEnter=function(e,n){var r=t.resolveArguments(e,n),i=r[0],o=r[1];t.removeClasses(i,"exit"),t.addClass(i,o?"appear":"enter","base"),t.props.onEnter&&t.props.onEnter(e,n)},t.onEntering=function(e,n){var r=t.resolveArguments(e,n),i=r[0],o=r[1];t.addClass(i,o?"appear":"enter","active"),t.props.onEntering&&t.props.onEntering(e,n)},t.onEntered=function(e,n){var r=t.resolveArguments(e,n),i=r[0],o=r[1]?"appear":"enter";t.removeClasses(i,o),t.addClass(i,o,"done"),t.props.onEntered&&t.props.onEntered(e,n)},t.onExit=function(e){var n=t.resolveArguments(e)[0];t.removeClasses(n,"appear"),t.removeClasses(n,"enter"),t.addClass(n,"exit","base"),t.props.onExit&&t.props.onExit(e)},t.onExiting=function(e){var n=t.resolveArguments(e)[0];t.addClass(n,"exit","active"),t.props.onExiting&&t.props.onExiting(e)},t.onExited=function(e){var n=t.resolveArguments(e)[0];t.removeClasses(n,"exit"),t.addClass(n,"exit","done"),t.props.onExited&&t.props.onExited(e)},t.resolveArguments=function(e,n){return t.props.nodeRef?[t.props.nodeRef.current,e]:[e,n]},t.getClassNames=function(e){var n=t.props.classNames,r="string"==typeof n,i=r&&n?n+"-":"",o=r?""+i+e:n[e],a=r?o+"-active":n[e+"Active"],s=r?o+"-done":n[e+"Done"];return{baseClassName:o,activeClassName:a,doneClassName:s}},t}ne(t,e);var n=t.prototype;return n.addClass=function(e,t,n){var r,i=this.getClassNames(t)[n+"ClassName"],o=this.getClassNames("enter").doneClassName;"appear"===t&&"done"===n&&o&&(i+=" "+o),"active"===n&&e&&ni(e),i&&(this.appliedClasses[t][n]=i,r=i,e&&r&&r.split(" ").forEach(function(t){e.classList?e.classList.add(t):(e.classList?t&&e.classList.contains(t):-1!==(" "+(e.className.baseVal||e.className)+" ").indexOf(" "+t+" "))||("string"==typeof e.className?e.className=e.className+" "+t:e.setAttribute("class",(e.className&&e.className.baseVal||"")+" "+t))}))},n.removeClasses=function(e,t){var n=this.appliedClasses[t],r=n.base,i=n.active,o=n.done;this.appliedClasses[t]={},r&&np(e,r),i&&np(e,i),o&&np(e,o)},n.render=function(){var e=this.props,t=(e.classNames,t8(e,["classNames"]));return i.default.createElement(nu,t9({},t,{onEnter:this.onEnter,onEntered:this.onEntered,onEntering:this.onEntering,onExit:this.onExit,onExiting:this.onExiting,onExited:this.onExited}))},t}(i.default.Component);nf.defaultProps={classNames:""},nf.propTypes={};let nh="modal",nm=tm.div.withConfig({displayName:"ModalWrapper__StyledModalWrapper",componentId:"sc-befc0f62-0"})`
...
`,ng=({children:e,toggled:t,height:n})=>{let o=(0,i.useRef)(null);return(0,r.jsx)(nf,{in:t,classNames:nh,timeout:300,nodeRef:o,children:(0,r.jsx)(nm,{ref:o,$toggled:t,$height:n,children:e})})},nv="594px",ny="3rem",nx=({close:e,toggled:t})=>{let{t:n}=tL();return(0,r.jsx)(ng,{toggled:t,height:nv,"aria-hidden":!t,children:(0,r.jsxs)(tK,{$toggled:t,method:"POST",action:"https://formspree.io/%63%6F%6E%74%61%63%74@%74%61%74%75%61%72%76%65%6C%61%2E%63%6F%6D",$height:nv,$dogEarSize:ny,children:[(0,r.jsx)(tW,{onClick:e,size:ny}),(0,r.jsx)("h2",{children:n("contact.title")}),(0,r.jsx)(t6,{id:"name",label:n("contact.name"),required:!0}),(0,r.jsx)(t6,{id:"email",label:n("contact.email"),required:!0}),(0,r.jsx)(t3,{id:"message",label:n("contact.message"),rows:8,required:!0}),(0,r.jsx)(tQ,{children:n("contact.send")})]})})},nb=tm.h1.withConfig({displayName:"Title__TitleElement",componentId:"sc-fb110ac-0"})`
  align-items: center;
  display: flex;
  flex-direction: column;
  font-weight: 600;
  ...
  position: relative;
  width: 100%;
`,nw=({segment:e})=>{let t=(0,i.useRef)(null),[n,o]=(0,i.useState)(1);return(0,i.useEffect)(()=>{let e=()=>{let e=t.current?.clientWidth??0;o(Math.min((t.current?.parentElement?.clientWidth??0)/e,1))};return window.addEventListener("resize",e),e(),()=>window.removeEventListener("resize",e)},[]),(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(nC,{$scale:n,children:e}),(0,r.jsx)(nC,{ref:t,$isReferenceElement:!0,children:e})]})},nS=`
  height: 0;
  left:-10000px;
  opacity: 0 !important;
  position:absolute;
  user-select: none;
`,nC=tm.span.withConfig({displayName:"Title__TitleSegmentBlock",componentId:"sc-fb110ac-1"})`
  ${tV};
  animation-delay: ${tX};
  display: block;
  font-size: calc(${tI} * ${e=>e.$scale??1});
  line-height: 1.2em;
  transition: font-size 0.3s ${tY};
  white-space: nowrap;
  width: fit-content;
...
`,n$=({title:e})=>(0,r.jsx)(nb,{children:(e=>{let t=[],n="";for(let r=0;r<e.length;r++){let i=e[r];n+=i,(" "===i&&n.length>2||r===e.length-1)&&(t.push(n),n="")}return t})(e).map(e=>(0,r.jsx)(nw,{segment:e},e))}),nE=tm.div.withConfig({displayName:"Container__StyledContainer",componentId:"sc-c8fba83a-0"})`
  align-items: center;
  display: flex;
  flex-direction: column;
  flex-grow: 1;
  justify-content: center;
  width: 100%;
`,nk=tm.div.withConfig({displayName:"Container__Content",componentId:"sc-c8fba83a-1"})`
  ${tH};
  animation-delay: ${tX};
  font-size: ${tN};
  line-height: 1.8em;
  max-width: 80vw;
  width: max-content;
`,nj=({title:e,children:t})=>(0,r.jsxs)(nE,{children:[(0,r.jsx)(n$,{title:e}),(0,r.jsx)(nk,{children:t})]}),nN=tm.div.withConfig({displayName:"Footer__StyledFooter",componentId:"sc-ee3afb51-0"})`
  ${tH};
  font-size: ${"13px"};
  text-align: center;
  margin-top: 2rem;
`,n_=()=>{let{t:e}=tL(),t=new Date().getFullYear();return(0,r.jsx)(nN,{children:(0,r.jsx)("p",{children:`\xa9 ${t} Tatu Arvela. ${e("footer.allRightsReserved")}`})})};var nI=e.i(8678);let nA=["fi_FI","en_US"],nR=()=>{let{t:e,locale:t}=tL(),n=e("site.description"),i=`Tatu Arvela — ${e("site.headline")}`,o="https://tatuarvela.com/image.png",a=nA.find(e=>e.includes(t)),s=nA.find(e=>e!==a),l="fi"===t?"https://tatuarvela.com/fi":"https://tatuarvela.com";return(0,r.jsxs)(nI.default,{children:[(0,r.jsx)("title",{children:i}),(0,r.jsx)("meta",{name:"description",content:n}),(0,r.jsx)("meta",{property:"og:image",content:o}),(0,r.jsx)("meta",{property:"og:title",content:i}),(0,r.jsx)("meta",{property:"og:description",content:n}),(0,r.jsx)("meta",{property:"og:locale",content:a}),(0,r.jsx)("meta",{property:"og:locale:alternate",content:s}),(0,r.jsx)("meta",{name:"twitter:card",content:"summary_large_image"}),(0,r.jsx)("meta",{name:"twitter:title",content:i}),(0,r.jsx)("meta",{name:"twitter:description",content:n}),(0,r.jsx)("meta",{name:"twitter:image",content:o}),(0,r.jsx)("meta",{name:"theme-color",content:"#040f3d"}),(0,r.jsx)("link",{rel:"canonical",href:l})]})},nO=tm.span.withConfig({displayName:"LinkText",componentId:"sc-cef4bdb8-0"})`
  position: relative;
  ...
  &::after {
    ...
    left: 0;
    position: absolute;
    transition: width 0.2s ${tY};
    width: 0;
    will-change: width;
  }
`,nP=tm.a.withConfig({displayName:"Link__StyledLink",componentId:"sc-6c9c4cf4-0"})`
  background: ${tk};
  color: ${tS};
  display: inline-block;
  text-decoration: none;
...
`,nT=({url:e,children:t})=>(0,r.jsx)(nP,{href:e,children:(0,r.jsx)(nO,{children:t})}),nz=tm.button.withConfig({displayName:"LinkButton__StyledLinkButton",componentId:"sc-de222f3c-0"})`
  background: ${tk};
  border: none;
  color: ${tS};
  display: inline-block;
...
`,nL=({children:e,onClick:t})=>(0,r.jsx)(nz,{onClick:t,children:(0,r.jsx)(nO,{children:e})}),nF=[{text:"LinkedIn",url:"https://www.linkedin.com/in/tatuarvela/"},{text:"GitHub",url:"https://github.com/TatuArvela"},{text:"Bēhance",url:"https://www.behance.net/TatuArvela"}];var nM=e.i(3828);let nD=()=>{let e=(0,nM.useRouter)(),{route:t}=e;return()=>{switch(t){case"/":return e.push("/fi","/fi");case"/fi":return e.push("/","/")}}},nG=th`
  height: calc((1.25rem * 2) * 5);
  padding: 1.25rem 0;
  pointer-events: auto;
  opacity: 1;
`,nB=tm.div.withConfig({displayName:"MobileNavigation__StyledMobileNavigation",componentId:"sc-ca972ea3-0"})`
...
`,nW=tm.ul.withConfig({displayName:"MobileNavigation__List",componentId:"sc-ca972ea3-1"})`
  display: flex;
  flex-direction: column;
  font-size: ${tN};
  list-style: none;
  ...
  overflow: hidden;
  padding-left: 0;
`,nY=tm.li.withConfig({displayName:"MobileNavigation__ListItem",componentId:"sc-ca972ea3-2"})`
  align-self: flex-end;
  display: none;
  flex-grow: 1;
  height: 2.5rem;
...
`,nU=({openForm:e,isOpen:t})=>{let{t:n}=tL(),o=nD(),[a,s]=(0,i.useState)(!1);return t&&!a&&s(!0),(0,i.useEffect)(()=>{if(!t){let e=setTimeout(()=>s(!1),400);return()=>clearTimeout(e)}},[t]),(0,r.jsx)(nB,{$isOpen:t,children:a&&(0,r.jsxs)(nW,{children:[nF.map(e=>(0,r.jsx)(nY,{children:(0,r.jsx)(nT,{url:e.url,children:e.text})},e.url)),(0,r.jsx)(nY,{children:(0,r.jsx)(nL,{onClick:e,children:n("navigation.contact")})}),(0,r.jsx)(nY,{children:(0,r.jsx)(nL,{onClick:o,children:n("navigation.switchLanguage")})})]})})},nH=tm.button.withConfig({displayName:"MobileNavigationToggle__StyledMobileNavigationToggle",componentId:"sc-5fc436d9-0"})`
  ${tH};
  background: none;
  border: none;
  color: ${tS};
...
`,nq=({isToggled:e,onClick:t})=>{let{t:n}=tL();return(0,r.jsx)(nH,{onClick:t,children:e?(0,r.jsx)(tM,{"aria-label":n("navigation.close")}):(0,r.jsx)(tG,{"aria-label":n("navigation.open")})})},nV=tm.div.withConfig({displayName:"Navigation__StyledNavigation",componentId:"sc-23222b1f-0"})`
  ${tH};
  display: flex;
  flex-direction: row;
  font-size: ${tN};
...
`,nX=tm.ul.withConfig({displayName:"Navigation__List",componentId:"sc-23222b1f-1"})`
  display: flex;
  font-size: ${tN};
  list-style: none;
  margin: 0;
  ...
  padding-left: 0;
  flex-direction: row;
`,nK=tm.li.withConfig({displayName:"Navigation__ListItem",componentId:"sc-23222b1f-2"})`
  display: inline;
  margin-left: 1em;
...
`,nJ=({openForm:e})=>{let{t}=tL(),n=nD();return(0,r.jsx)(nV,{children:(0,r.jsxs)(nX,{children:[nF.map(e=>(0,r.jsx)(nK,{children:(0,r.jsx)(nT,{url:e.url,children:e.text})},e.url)),(0,r.jsx)(nK,{children:(0,r.jsx)(nL,{onClick:e,children:t("navigation.contact")})}),(0,r.jsx)(nK,{children:(0,r.jsx)(nL,{onClick:n,children:t("navigation.switchLanguage")})})]})})},nZ=tm.div.withConfig({displayName:"Header__StyledHeader",componentId:"sc-e7c16e5a-0"})`
  ${tH};
  align-items: center;
  display: flex;
  ...
  margin: 0;
  padding: 0;
`,nQ=tm.h2.withConfig({displayName:"Header__Title",componentId:"sc-e7c16e5a-1"})`
  display: block;
  flex-grow: 1;
  line-height: 1.5;
  margin: 0;
  transform: translateX(1.5rem);
  transition: transform 0.4s ${tY};

  @media screen and (max-width: ${tR}) {
    margin-left: 0;
    transform: translateX(0);
  }
`,n0=({openForm:e})=>{let[t,n]=(0,i.useState)(!1);return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsxs)(nZ,{children:[(0,r.jsx)(nQ,{children:"Tatu Arvela"}),(0,r.jsx)(nJ,{openForm:e}),(0,r.jsx)(nq,{isToggled:t,onClick:()=>n(e=>!e)})]}),(0,r.jsx)(nU,{isOpen:t,openForm:e})]})},n1=tm.div.withConfig({displayName:"Page__StyledPage",componentId:"sc-baac39e8-0"})`
  box-sizing: border-box;
  display: flex;
  flex-direction: column;
  min-height: 100vh;
...
`;e.s(["default",0,({pageTitle:e,children:t})=>{let[n,o]=(0,i.useState)(!1);return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(tO,{}),(0,r.jsx)(nR,{}),(0,r.jsxs)(n1,{children:[(0,r.jsx)(n0,{openForm:()=>o(!0)}),(0,r.jsx)(nj,{title:e,children:t}),(0,r.jsx)(n_,{})]}),(0,r.jsx)(nx,{toggled:n,close:()=>o(!1)})]})}],2474)}]);